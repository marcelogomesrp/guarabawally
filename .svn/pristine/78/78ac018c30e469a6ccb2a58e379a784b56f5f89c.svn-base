...
public class HTTPUtils {
	...
	public static String post(String url, Map<String, String> parameters)
			throws URISyntaxException, ClientProtocolException, IOException, ServiceException, HttpHostConnectException {
		...
		if (parameters != null && parameters.size() > 0) {
			...
			for (String parameter : parameters.keySet()) {
				...
				requestParameters.add(new BasicNameValuePair(parameter,
