...
public class HTTPRequestHelper {
    ...
    public static final String LOGTAG = "GuarabaWally";
     ...
     * 
     */
    public void performGet(final String url, final String user, final String pass, final Map<String, String> additionalHeaders) {
     ...
     * 
     */
    public void performPost(final String contentType, final String url, final String user, final String pass, final Map<String, String> additionalHeaders, final Map<String, String> params) {
     ...
     * 
     */
    public void performPost(final String url, final String user, final String pass, final Map<String, String> additionalHeaders, final Map<String, String> params) {
    ...
    private void performRequest(final String contentType, final String url, final String user, final String pass, final Map<String, String> headers, final Map<String, String> params, final int requestType) {
        ...
        Log.d(LOGTAG, " " + HTTPRequestHelper.CLASSTAG + " making HTTP request to url - " + url);
        ...
        if ((user != null) && (pass != null)) {
            Log.d(LOGTAG, " " + HTTPRequestHelper.CLASSTAG + " user and pass present, adding credentials to request");
                ...
                public void process(final HttpRequest request, final HttpContext context) throws HttpException, IOException {
                	...
                	for (String key : sendHeaders.keySet()) {
                		...
                		if (!request.containsHeader(key)) {
                            Log.d(LOGTAG, " " + HTTPRequestHelper.CLASSTAG + " adding header: " + key + " | " + sendHeaders.get(key));
        ...
        if (requestType == HTTPRequestHelper.POST_TYPE) {
            Log.d(LOGTAG, " " + HTTPRequestHelper.CLASSTAG + " performRequest POST");
            ...
            if ((params != null) && (params.size() > 0)) {                
                ...
                for (String key : params.keySet()) {
                    Log.d(LOGTAG, " " + HTTPRequestHelper.CLASSTAG + " adding param: " + key + " | " + params.get(key));
            ...
            if (nvps != null) {
                try {
                    ...
                    Log.e(LOGTAG, " " + HTTPRequestHelper.CLASSTAG, e);
                }
            }

            try {
                client.execute(method, this.responseHandler);
                Log.d(LOGTAG, " " + HTTPRequestHelper.CLASSTAG + " request completed");
            } catch (Exception e) {
                Log.e(LOGTAG, " " + HTTPRequestHelper.CLASSTAG, e);
                ...
                try {
                    ...
                    Log.e(LOGTAG, " " + HTTPRequestHelper.CLASSTAG, ex);
                }
            }
        } else if (requestType == HTTPRequestHelper.GET_TYPE) {
            Log.d(LOGTAG, " " + HTTPRequestHelper.CLASSTAG + " performRequest GET");
    ...
    public static ResponseHandler<String> getResponseHandlerInstance(final Handler handler) {
        ...
        final ResponseHandler<String> responseHandler = new ResponseHandler<String>() {
            ...
            public String handleResponse(final HttpResponse response) {
                ...
                Log.d(LOGTAG, " " + HTTPRequestHelper.CLASSTAG + " statusCode - " + status.getStatusCode());
                Log.d(LOGTAG, " " + HTTPRequestHelper.CLASSTAG + " statusReasonPhrase - "
                ...
                if (entity != null) {
                    ...
                    Log.w(LOGTAG, " " + HTTPRequestHelper.CLASSTAG
